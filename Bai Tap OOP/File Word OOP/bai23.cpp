...
public:
    ...
    PhanSo TongTatCaPhanSoNhoHon1Phan2(const PhanSo *, const int);
...
PhanSo PhanSo::TongTatCaPhanSoNhoHon1Phan2(const PhanSo *arr, const int n)
{
    PhanSo sum(0, 1);
    for (int i = 0; i < n; i++)
    {
...
int main()
{
    ...
    cout << endl
         << setw(40) << "=> Tong Tat Ca Ca Phan So Nho Hon 1/2 La: " << arr->TongTatCaPhanSoNhoHon1Phan2(arr, n) << endl;
